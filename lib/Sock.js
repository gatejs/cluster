...
Sock.prototype._send = function (event, data, mt, opts) {
	...
	if(!cells) {
		if(this._router && this._router.hostname) cells = this._router.hostname
	}

	const buff = this._serializer.serialize(event, data, mt, messageId, cells, policy);
