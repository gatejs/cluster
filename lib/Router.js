...
Router.prototype.reflector = function (sock) {
	...
	sock._onMessage = (msg) => {
		...
		if(msg.mt == Serializer.MT_UL_NEW_LINK) {
			...
			//console.log(this.hostname, "MT_DATA_BROADCAST ", msg.cells, msg.mt, msg.data);
			const pk = msg.data;
			...
			//console.log(this.hostname, "MT_DATA_TO_ROOM ", msg.cells, msg.mt, msg.data);
			const pk = msg.data;
			...
			//console.log(this.hostname, "MT_DATA_TO_SOCKET ", msg.cells, msg.mt, msg.data);
			const pk = msg.data;
